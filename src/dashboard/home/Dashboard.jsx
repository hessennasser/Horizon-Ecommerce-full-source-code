                        ...
                        <div className='container py-10'>
                            <div className="mb-10 flex flex-col items-start gap-2 sm:flex-row sm:items-center justify-between">
                                ...
                                <div className="flex items-center gap-5">
                                    ...
                                    <button type='button' onClick={openAddtModal} className='bg-secondColor hover:bg-mainColor duration-200 py-2 px-4 rounded-lg hover:brightness-110 text-white'>{i18n.language === "en" ? "Add Product" : "اضافة منتج جديد"}</button>
                                </div>
                            </div>
                            {
                                allProducts.length > 0 ? (
                                    ...
                                    (
                                        <div className="flex flex-col items-center justify-center min-h-[40dvh]">
                                            ...
                                            <button type='button' onClick={openAddtModal} className='bg-secondColor py-2 px-4 rounded-lg hover:brightness-110 text-white mt-5'>{i18n.language === "en" ? "Add Product" : "اضافة منتج جديد"}</button>
                                        </div>
